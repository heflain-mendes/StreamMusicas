...
public interface IReproducaoService {
    ...
    List<IMusica> obterRecomendacoesDuranteReproducao(IRecomendacaoService recomendacaoService,
                                                     IUsuario usuario);
    String exibirInformacoesArtistaDuranteReproducao(IMusica musica,
